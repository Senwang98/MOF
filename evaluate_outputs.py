...
parser.add_argument('-gt', help='Path to ground truth directory',default = './outputs/ground_truth/')
parser.add_argument('-pred', help='Path to prediction directory',default = './outputs/sted/')
